...
Modules.addCached("eucWatch", function() {
  ...
  function toFlatString(arr) {
    //"ram";
    var b = E.toFlatString(arr);
    if (b) return b;
    print("toFlatString() fail&retry!");
    E.defrag();
    b = E.toFlatString(arr);
    if (b) return b;
